...
class ModelTrainer:
    ...
    def val(self, model, dataloader, step, loss_fn, writer):
        ...
        writer.add_scalar("val/epoch_loss", loss / len(dataloader), global_step=step)
        writer.add_scalar("val/AA", conf_mat.get_aa(), global_step=step)
        writer.add_scalar("val/mIoU", conf_mat.get_mIoU(), global_step=step)
